...
def is_transaction_successful(money_received, drink_cost):
    ...
    if money_received >= drink_cost:
        ...
        print(f"There is ${change} in return")
        profit += drink_cost
        return True
    else:
...
def make_coffee(drink_name, order_ingredients):
    ...
    print(f"Here is your drink : {drink_name} ☕️ enjoy it!")
...
# b. Once all resources have been deducted, tell the user “Here is your latte. Enjoy!”. If latte was their
# choice of drink.
